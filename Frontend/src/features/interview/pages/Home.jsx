        ...
        <div className='home-page'>
            <div className='home-topbar'>
                <div className='home-brand'>
                    <span className='home-brand__icon' aria-label='Gemini icon'>
                    ...
                    <span className='home-brand__title'>Hireprep_ai</span>
                </div>

                <button onClick={handleLogoutClick} className='topbar-logout'>
                    Logout
                </button>
            </div>
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label className='dropzone' htmlFor='resume'>
                                ...
                                <input ref={resumeInputRef} hidden      
                                type='file'
                                id='resume'
                                name='resume'
                                accept='.pdf'
